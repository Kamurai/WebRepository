	...
	<xsl:template name="GetNavigation">
		...
		<div>
			<a className="navlinkA" href="{$vPath}Division1/Section1/Index.xml">Databases</a><br /><br />
				<a className="navlinkA" href="{$vPath}Division1/Section1/Project1.xml">Oracle</a><br /><br />
				<a className="navlinkA" href="{$vPath}Division1/Section1/Project2.xml">Derby</a><br /><br />
				<a className="navlinkA" href="{$vPath}Division1/Section1/Project3.xml">MySQL</a><br /><br />
				<a className="navlinkA" href="{$vPath}Division1/Section1/Project4.xml">SQL Server</a><br /><br />
				<a className="navlinkA" href="{$vPath}Division1/Section1/Project5.xml">PostgreSQL</a><br /><br />
		</div>
	</xsl:template>
