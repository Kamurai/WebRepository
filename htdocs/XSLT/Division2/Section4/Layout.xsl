	...
	<xsl:template name="GetNavigation">
		...
		<div>
			...
			<a className="navlinkA" href="{$vPath}Division2/Section4/Index.xml">Renley</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section4/Project1.xml">Warring Nations</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section4/Project2.xml">Psychodom: The One Empire</a><br /><br />
