	...
	<xsl:template name="GetNavigation">
		...
		<div>
			...
			<a className="navlinkA" href="{$vPath}Division2/Section5/Index.xml">Antarrea</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section5/Section1/Index.xml">Global</a><br /><br />
					<a className="navlinkC" href="{$vPath}Division2/Section5/Section1/Project1.html"}>Team Tactial: Crash Ball</a><br /><br />
					<a className="navlinkC" href="{$vPath}Division2/Section5/Section1/Project2.html"}>Wars of Antarrea</a><br /><br />
					<a className="navlinkC" href="{$vPath}Division2/Section5/Section1/Project3.html"}>Revolutions: Invading Nations</a><br /><br />
					<a className="navlinkC" href="{$vPath}Division2/Section5/Section1/Project4.html"}>Revolutions: Rebellion Against the Fist</a><br /><br />
					<a className="navlinkC" href="{$vPath}Division2/Section5/Section1/Project5.html"}>Revolutions: Return to Arms</a><br /><br />
					<a className="navlinkC" href="{$vPath}Division2/Section5/Section1/Project6.html"}>Revolutions: Post Wars</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section5/Section2/Index.xml">Grendol</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section5/Section3/Index.xml">Utopia</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section5/Section4/Index.xml">Elvia</a><br /><br />
