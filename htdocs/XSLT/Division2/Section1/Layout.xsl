	...
	<xsl:template name="GetNavigation">
		...
		<div>
			<a className="navlinkA" href="{$vPath}Division2/Section1/Index.xml">Gynowars</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section1/Project1.xml">Gynowars RPG</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section1/Project2.xml">Gynowars: Battle Arena CCG</a><br /><br />
				<a className="navlinkB" href="{$vPath}Division2/Section1/Project3.xml">Gynowars: Crash Ball</a><br /><br />
