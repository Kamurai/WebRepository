	...
	<xsl:template name="GetTitle">
		...
		<title>
			<xsl:choose>
				...
				<xsl:when test="$vPage = 1">Cube World Downloads</xsl:when>
				<xsl:when test="$vPage = 2">Minecraft Downloads</xsl:when>
				<xsl:when test="$vPage = 3">Game Maker Downloads</xsl:when>
				<xsl:when test="$vPage = 4">Java Downloads</xsl:when>
			...
			<xsl:choose>
				...
				<xsl:when test="$vPage = 1">
					<ul class="versionsUl">
						...
						<li><a href="http://htkb.dyndns.org/JSX/Division4/Project1.html">JSX</a></li>
						<li><a href="http://htkb.dyndns.org/XLST/Division4/Project1.xml">XSLT</a></li>
				...
				<xsl:when test="$vPage = 2">
					<ul class="versionsUl">
						...
						<li><a href="http://htkb.dyndns.org/JSX/Division4/Project2.html">JSX</a></li>
						<li><a href="http://htkb.dyndns.org/XLST/Division4/Project2.xml">XSLT</a></li>
				...
				<xsl:when test="$vPage = 3">
					<ul class="versionsUl">
						...
						<li><a href="http://htkb.dyndns.org/JSX/Division4/Project3.html">JSX</a></li>
						<li><a href="http://htkb.dyndns.org/XLST/Division4/Project3.xml">XSLT</a></li>
				...
				<xsl:when test="$vPage = 4">
					<ul class="versionsUl">
						...
						<li><a href="http://htkb.dyndns.org/JSX/Division4/Project4.html">JSX</a></li>
						<li><a href="http://htkb.dyndns.org/XLST/Division4/Project4.xml">XSLT</a></li>
				...
				<xsl:when test="$vPage = 5">
					<ul class="versionsUl">
						...
						<li><a href="http://htkb.dyndns.org/JSX/Division4/Project5.html">JSX</a></li>
						<li><a href="http://htkb.dyndns.org/XLST/Division4/Project5.xml">XSLT</a></li>
