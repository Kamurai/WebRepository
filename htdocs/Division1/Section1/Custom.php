<?php
    ...
    function getVersions($vPage)
    {
        ...
        else if($vPage==4)
        {
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org:81/MVC/Division1/Section1/Project4\'>ASP.NET MVC App</a><br>';
        ...
        else if($vPage==5)
        {
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org:81/MVC/Division1/Section1/Project5\'>ASP.NET MVC App</a><br>';
