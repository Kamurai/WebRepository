        ...
        $vResult = '
			...
			<a class=\'navlinkA\' href=\''.getPath($vLevel).'Division2/Section5/Index.php\'>Antarrea</a></br></br>
				<a class=\'navlinkB\' href=\''.getPath($vLevel).'Division2/Section5/Section1/Index.php\'>Global:</a></br></br>
					<a class=\'navlinkC\' href=\''.getPath($vLevel).'Division2/Section5/Section1/Project1.php\'>Team Tactial: Crash Ball</a></br></br>
					<a class=\'navlinkC\' href=\''.getPath($vLevel).'Division2/Section5/Section1/Project2.php\'>Wars of Antarrea</a></br></br>
					<a class=\'navlinkC\' href=\''.getPath($vLevel).'Division2/Section5/Section1/Project3.php\'>Revolutions: Invading Nations:</a></br></br>
					<a class=\'navlinkC\' href=\''.getPath($vLevel).'Division2/Section5/Section1/Project4.php\'>Revolutions: Rebellion Against the Fist</a></br></br>
					<a class=\'navlinkC\' href=\''.getPath($vLevel).'Division2/Section5/Section1/Project5.php\'>Revolutions: Return to Arms</a></br></br>
					<a class=\'navlinkC\' href=\''.getPath($vLevel).'Division2/Section5/Section1/Project6.php\'>Revolutions: Post Wars</a></br></br>
