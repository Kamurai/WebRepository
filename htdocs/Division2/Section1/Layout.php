    ...
    function getNavigation($vLevel)
    {
        $vResult = '
            <a class=\'navlinkA\' href=\''.getPath($vLevel).'Division2/Section1/Index.php\'>Gynowars</a></br></br>
                <a class=\'navlinkB\' href=\''.getPath($vLevel).'Division2/Section1/Project1.php\'>Gynowars RPG</a></br></br>
                <a class=\'navlinkB\' href=\''.getPath($vLevel).'Division2/Section1/Project2.php\'>Gynowars: Battle Arena CCG</a></br></br>
                <a class=\'navlinkB\' href=\''.getPath($vLevel).'Division2/Section1/Project3.php\'>Gynowars: Crash Ball</a></br></br>
