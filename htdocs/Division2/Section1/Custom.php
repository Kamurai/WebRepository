<?php
    ...
    function getVersions($vPage)
    {
		...
		$vDefault = $vDefault.'<a href=\'http://htkb.dyndns.org/Angular/Division2/Section1/Index.html\'>Angular JS</a><br>';
        ...
        else if($vPage==1)
        {
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org/Angular/Division2/Section1/Project1.html\'>Angular JS</a><br>';
        ...
        else if($vPage==2)
        {
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org/Angular/Division2/Section1/Project2.html\'>Angular JS</a><br>';
        ...
        else if($vPage==3)
        {
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org/Angular/Division2/Section1/Project3.html\'>Angular JS</a><br>';
