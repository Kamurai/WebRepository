<?php
    ...
    function getVersions($vPage)
    {
		...
		$vDefault = $vDefault.'<a href=\'http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section4/Index\'>JSP Spring MVC</a><br>';
        ...
        else if($vPage==1)
        {
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section4/Project1\'>JSP Spring MVC</a><br>';
        ...
        else if($vPage==2)
        {
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section4/Project2\'>JSP Spring MVC</a><br>';
        ...
        else if($vPage==3)
        {
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org:8080/ProjectSpringTestSite/Division2/Section4/Project3\'>JSP Spring MVC</a><br>';
			...
			$vResult = $vResult.'<a href=\'http://htkb.dyndns.org:81/MVC/Division2/Section4/Project3\'>ASP.NET MVC App</a><br>';
