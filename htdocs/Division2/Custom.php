        ...
        else if($vPage==10)
        {
			...
			$vResult = $vResult.'<ol class=\'classFirstOrder\'>';
				...
				$vResult = $vResult.'<ul class=\'classSecondOrder\'>';
					$vResult = $vResult.'<li>Each player starts with 10 score tokens.</li>';
					$vResult = $vResult.'<li>20 points per player are added to the community point pool.</li>';
					$vResult = $vResult.'<li>The crown token goes in the point pool.</li>';
					$vResult = $vResult.'<li>The marketplace must be created based on the number of players:</li>';
					$vResult = $vResult.'<ul class=\'classThirdOrder\'>';
						$vResult = $vResult.'<li>Each player may select one card from their faction for the stock.</li>';
						$vResult = $vResult.'<li>The remaining stock should be determined as evenly as possible from the in game factions:</li>';
						$vResult = $vResult.'<ul class=\'classFourthOrder\'>';
							$vResult = $vResult.'<li>2 players:	4 stock per player</li>';
							$vResult = $vResult.'<li>3 players:	2 stock per player, 2 random stocks</li>';
							$vResult = $vResult.'<li>4 players:	2 stock per player</li>';
							$vResult = $vResult.'<li>5 players:	1 stock per player, 3 random stocks</li>';
							$vResult = $vResult.'<li>6 players:	1 stock per player, 2 random stocks</li>';
							$vResult = $vResult.'<li>7 players:	1 stock per player, 1 random stock</li>';
							$vResult = $vResult.'<li>8 players:	1 stock per player</li>';
						$vResult = $vResult.'</ul>';
					$vResult = $vResult.'</ul>';
					$vResult = $vResult.'<li>Alternative:</li>';
					$vResult = $vResult.'<ul class=\'classFourthOrder\'>';
						$vResult = $vResult.'<li>Randomly select 8 stocks.  These can be chosen from the following options:</li>';
						$vResult = $vResult.'<li>Split between in game factions.</li>';
						$vResult = $vResult.'<li>Randomly chosen from in game factions.</li>';
						$vResult = $vResult.'<li>Randomly chosen from any/all available factions.</li>';
						$vResult = $vResult.'<li>Random selection from in game factions with excess being chosen from out of game factions.</li>';
					$vResult = $vResult.'</ul>';
				$vResult = $vResult.'</ul>';
				$vResult = $vResult.'<li>Phases:</li>';
					$vResult = $vResult.'<ul class=\'classSecondOrder\'>';
						$vResult = $vResult.'<li>Play:</li>';
						$vResult = $vResult.'<ul class=\'classThirdOrder\'>';
							$vResult = $vResult.'<li>Cast:  Play cards to the field.</li>';
							$vResult = $vResult.'<li>Assault:  Exhaust characters to resolve their effects.</li>';
						$vResult = $vResult.'</ul>';
						$vResult = $vResult.'<li>Clean: Discard any exhausted cards in play, remove any cards that used its last wish token from play.</li>';
						$vResult = $vResult.'<li>Split between in game factions.</li>';
						$vResult = $vResult.'<ul class=\'classThirdOrder\'>';
							$vResult = $vResult.'<li>Discard cards by player choice.</li>';
							$vResult = $vResult.'<li>Draw cards until the player has 5 cards.</li>';
						$vResult = $vResult.'</ul>';
					$vResult = $vResult.'</ul>';
				$vResult = $vResult.'<li>(Stage 2) A princess may be flipped over if any of the following conditions are met:</li>';
					$vResult = $vResult.'<ul class=\'classSecondOrder\'>';
						$vResult = $vResult.'<li>A player sacrifices 10 points.</li>';
						$vResult = $vResult.'<li>A player pays 10 resources.</li>';
						$vResult = $vResult.'<li>A player has at least half the number of points to win. (Quarter of total points)</li>';
					$vResult = $vResult.'</ul>';
				$vResult = $vResult.'<li>Tokens:</li>';
					$vResult = $vResult.'<ul class=\'classSecondOrder\'>';
						$vResult = $vResult.'<li>Crown:  Worth 10 points.</li>';
						$vResult = $vResult.'<li>Score:  Worth 1 point.</li>';
						$vResult = $vResult.'<li>Wish:  Worth 1 wish.</li>';
					$vResult = $vResult.'</ul>';
				$vResult = $vResult.'<li>End condition:</li>';
					$vResult = $vResult.'<ul class=\'classSecondOrder\'>';
						$vResult = $vResult.'<li>Scenario 1:  One player has half of the available points.</li>';
						$vResult = $vResult.'<li>Scenario 2:  All but one player has 0 points.</li>';
					$vResult = $vResult.'</ul>';
				$vResult = $vResult.'<li>Win condition:</li>';
					$vResult = $vResult.'<ul class=\'classSecondOrder\'>';
						$vResult = $vResult.'<li>One player has half of the available points.</li>';
						$vResult = $vResult.'<ul class=\'classThirdOrder\'>';
							$vResult = $vResult.'<li>2 players:  10+20 = 30, 30*2 = 60, 60 + 10 (Crown) = 70, 70 / 2 (Number of players) = 35 (to win)</li>';
						$vResult = $vResult.'</ul>';
						$vResult = $vResult.'<li>All other players are reduced to 0 points.</li>';
					$vResult = $vResult.'</ul>';
				$vResult = $vResult.'<li>Loss condition:</li>';
					$vResult = $vResult.'<ul class=\'classSecondOrder\'>';
						$vResult = $vResult.'<li>Any player having 0 points when the game ends, loses.</li>';
						$vResult = $vResult.'<li>Another player attains a win condition.</li>';
					$vResult = $vResult.'</ul>';
			$vResult = $vResult.'</ol>';	
        }
        else if($vPage==11)
