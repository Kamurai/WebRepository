	...
	function getNavigation($vLevel){
        $vResult = "
			<ul class=\"navigationUl\">
				<li><a class=\"navlinkA\" href=\"../Indx.php\">Video Games</a></li>
				...
				<ul class=\"navigationUl\">
					<li><a class=\"navlinkB\" href=\"./Project1.php\">Warring Nations</a></li>
					<li><a class=\"navlinkB\" href=\"./Project2.php\">Psychodom: The One Empire</a></li>
				</ul>
			</ul>
		";
