		...
		<div>
			...
			<a className="navlinkA" href={getPath(vLevel)+"Division2/Section5/Index.html"}>Antarrea</a><br /><br />
				...
				<a className="navlinkB" href={getPath(vLevel)+"Division2/Section5/Section2/Index.html"}>Grendol</a><br /><br />
					<a className="navlinkC" href={getPath(vLevel)+"Division2/Section5/Section2/Project1.html"}>Land of the Orcish Empire: Age of Magic</a><br /><br />
					<a className="navlinkC" href={getPath(vLevel)+"Division2/Section5/Section2/Project2.html"}>Coliseum: Arena</a><br /><br />
