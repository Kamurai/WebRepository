	...
	return (
		<div>
			...
			<a className="navlinkA" href={getPath(vLevel)+"Division2/Section4/Index.html"}>Renley</a><br /><br />
				<a className="navlinkB" href={getPath(vLevel)+"Division2/Section4/Project1.html"}>Warring Nations</a><br /><br />
				<a className="navlinkB" href={getPath(vLevel)+"Division2/Section4/Project2.html"}>Psychodom: The One Empire</a><br /><br />
