	...
	return (
		<div>
			<a className="navlinkA" href={getPath(vLevel)+"Division2/Section1/Index.html"}>Gynowars</a><br /><br />
				<a className="navlinkB" href={getPath(vLevel)+"Division2/Section1/Project1.html"}>Gynowars RPG</a><br /><br />
				<a className="navlinkB" href={getPath(vLevel)+"Division2/Section1/Project2.html"}>Gynowars: Battle Arena CCG</a><br /><br />
				<a className="navlinkB" href={getPath(vLevel)+"Division2/Section1/Project3.html"}>Gynowars: Crash Ball</a><br /><br />
