...
function Versions(vPage)
{
	...
	if(vPage == 0)
	{
		...
		document.write("<a href=\"http://htkb.dyndns.org/JQuery/Section2/Section6/Section2/index.php\">JQuery</a><br>");
        ...
        document.write("<a href=\"http://htkb.dyndns.org:84/Section2/Section6/Section2/index\">Node JS</a><br>");
		...
		document.write("<a href=\"http://htkb.dyndns.org:81/MVC/Section2/Section6/Section2/index\">ASP.NET MVC App</a><br>");
		document.write("<a href=\"http://htkb.dyndns.org/SSI/Section2/Section6/Section2/index.html\">Apache SSI</a><br>");
        document.write("<a href=\"http://htkb.dyndns.org:82/Section2/Section6/Section2/index\">Python Web.py</a><br>");
        document.write("<a href=\"http://htkb.dyndns.org:83/Section2/Section6/Section2/index\">Ruby on Rails</a><br>");
    }
	else if(vPage == 1)
	{
		...
		document.write("<a href=\"http://htkb.dyndns.org/JQuery/Section2/Section6/Section2/Project1.php\">JQuery</a><br>");
        ...
        document.write("<a href=\"http://htkb.dyndns.org:84/Section2/Section6/Section2/Project1\">Node JS</a><br>");
		...
		document.write("<a href=\"http://htkb.dyndns.org:81/MVC/Section2/Section6/Section2/Project1\">ASP.NET MVC App</a><br>");
		document.write("<a href=\"http://htkb.dyndns.org/SSI/Section2/Section6/Section2/Project1.html\">Apache SSI</a><br>");
        document.write("<a href=\"http://htkb.dyndns.org:82/Section2/Section6/Section2/Project1\">Python Web.py</a><br>");
        document.write("<a href=\"http://htkb.dyndns.org:83/Section2/Section6/Section2/Project1\">Ruby on Rails</a><br>");
    }
