function getNavigation(vLevel)
{
	...
	vResult += "<a class=\"navlinkA\" href=\""+getPath(vLevel)+"Division2/Section5/Index.html\">Antarrea</a><br><br>";
		vResult += "<a class=\"navlinkB\" href=\""+getPath(vLevel)+"Division2/Section5/Section1/Index.html\">Global</a><br><br>";
			vResult += "<a class=\"navlinkC\" href=\""+getPath(vLevel)+"Division2/Section5/Section1/Project1.html\">Team Tactial: Crash Ball</a><br><br>";
			vResult += "<a class=\"navlinkC\" href=\""+getPath(vLevel)+"Division2/Section5/Section1/Project2.html\">Wars of Antarrea</a><br><br>";
			vResult += "<a class=\"navlinkC\" href=\""+getPath(vLevel)+"Division2/Section5/Section1/Project3.html\">Revolutions: Invading Nations</a><br><br>";
			vResult += "<a class=\"navlinkC\" href=\""+getPath(vLevel)+"Division2/Section5/Section1/Project4.html\">Revolutions: Rebellion Against the Fist</a><br><br>";
			vResult += "<a class=\"navlinkC\" href=\""+getPath(vLevel)+"Division2/Section5/Section1/Project5.html\">Revolutions: Return to Arms</a><br><br>";
			vResult += "<a class=\"navlinkC\" href=\""+getPath(vLevel)+"Division2/Section5/Section1/Project6.html\">Revolutions: Post Wars</a><br><br>";
