vApp.controller("CustomController", ['$scope', '$sce', function ($scope, $sce){
	$scope.getTitle = function(){
		...
		$scope.vResult += "<title>";
			if(vPage == 0){
				...
				$scope.vResult += "MacCreedy's Mansion";
			}else if(vPage == 7){
				$scope.vResult += "Dundered Acre Wood";
			}else if(vPage == 8){
				$scope.vResult += "Conquer";
			}else if(vPage == 9){
				$scope.vResult += "Assault";
			}else if(vPage == 10){
				$scope.vResult += "Battle Princesses";
			}else if(vPage == 11){
				$scope.vResult += "Armor Up";
			}else if(vPage == 12){
				$scope.vResult += "Gynowars: Battle Arena";
			}else if(vPage == 13){
				...
				$scope.vResult += "Antarrea RPG";
			}else if(vPage == 18){
				$scope.vResult += "Super Dungeon Adventure";
			}else{
				$scope.vResult += $scope.vDefault;
			}
		$scope.vResult += "</title>";
	...
	$scope.getContent = function(){
		...
		$scope.vDefault += "This section is dedicated to board game projects.";
