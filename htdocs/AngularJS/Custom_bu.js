angular.module('vApp', []).controller('CustomController', ['$scope', '$sce', function ($scope, $sce)
{
	...
	$scope.Versions = function(vPage)
	{
        ...
        $scope.vDefault += "<a href=\'http://htkb.dyndns.org:81/ASP/Index.asp\'>ASP Javascript</a><br>";
