vApp.controller("CustomController", ['$scope', '$sce', function ($scope, $sce){
	$scope.getTitle = function(){
		...
		$scope.vResult += "<title>";
			if(vPage == 0){
				...
				$scope.vResult += "The Wrong Ninja";
			}else if(vPage == 3){
				$scope.vResult += "Gynowars";
			}else if(vPage == 4){
				$scope.vResult += "Terminal World";
			}else if(vPage == 5){
				$scope.vResult += "Mars: Opposition";
			}else{
				$scope.vResult += $scope.vDefault;
			}
		$scope.vResult += "</title>";
	...
	$scope.getContent = function(){
		...
		$scope.vDefault += "This section is dedicated to video game projects.";
