angular.module('Universal', []).controller('CustomController', function ($scope)
{
	$scope.Navigation = function(vLevel)
	{
		document.write("<span class='navlink'>");
			document.write("<a href='"+GetPath(vLevel)+"AboutUs.html'>About Us</a>");
		document.write("</span>");
		document.write("<br>");
		document.write("<span class='navlink'>");
			document.write("<a href='"+GetPath(vLevel)+"Media.html'>Media</a>");
		document.write("</span>");
		document.write("<br>");
		document.write("<span class='navlink'>");
