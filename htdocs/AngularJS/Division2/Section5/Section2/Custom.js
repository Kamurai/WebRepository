vApp.controller("CustomController", ['$scope', '$sce', function ($scope, $sce)
{
	...
	$scope.getVersions = function()
	{
		...
		$scope.vDefault += "<a href=\"http://htkb.dyndns.org:8080/SpringMVC/Division2/Section5/Section2/Index.jsp\">JSP Spring MVC</a><br>";
		...
		else if(vPage == 1)
		{
			...
			$scope.vResult += "<a href=\"http://htkb.dyndns.org:8080/SpringMVC/Division2/Section5/Section2/Project1.jsp\">JSP Spring MVC</a><br>";
		...
		else if(vPage == 2)
		{
			...
			$scope.vResult += "<a href=\"http://htkb.dyndns.org:8080/SpringMVC/Division2/Section5/Section2/Project2.jsp\">JSP Spring MVC</a><br>";
