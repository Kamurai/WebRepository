vApp.controller("CustomController", ['$scope', '$sce', function ($scope, $sce)
{
	...
	$scope.getVersions = function()
	{
		...
		$scope.vDefault += "<a href=\"http://htkb.dyndns.org:8080/SpringMVC/Division2/Section4/Index.jsp\">JSP Spring MVC</a><br>";
		...
		if(vPage == 0)
		{
			...
			$scope.vResult += "<a href=\"http://htkb.dyndns.org:8080/SpringMVC/Division2/Section4/Index.jsp\">JSP Spring MVC</a><br>";
		...
		else if(vPage == 1)
		{
			...
			$scope.vResult += "<a href=\"http://htkb.dyndns.org:8080/SpringMVC/Division2/Section4/Project1.jsp\">JSP Spring MVC</a><br>";
		...
		else if(vPage == 2)
		{
			...
			$scope.vResult += "<a href=\"http://htkb.dyndns.org:8080/SpringMVC/Division2/Section4/Project2.jsp\">JSP Spring MVC</a><br>";
