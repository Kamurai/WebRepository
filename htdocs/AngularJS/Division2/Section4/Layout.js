vApp.controller("LayoutController", ['$scope', '$sce', function ($scope, $sce)
{
	$scope.getNavigation = function()
	{
		...
		$scope.vResult += "<a class=\"navlinkA\" href=\""+getPath(vLevel)+"Division2/Section4/Index.html\">Renley</a><br><br>";
			$scope.vResult += "<a class=\"navlinkB\" href=\""+getPath(vLevel)+"Division2/Section4/Project1.html\">Warring Nations</a><br><br>";
			$scope.vResult += "<a class=\"navlinkB\" href=\""+getPath(vLevel)+"Division2/Section4/Project2.html\">Psychodom: The One Empire</a><br><br>";
