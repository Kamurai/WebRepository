function Navigation(vLevel)
{
	document.write("<span class='navlink'>");
		document.write("<a href='"+GetPath(vLevel)+"Section2/Section1/Index.html'>Gynowars</a>");
			document.write("<h5>");
				document.write("<span class='navlink'>");
					document.write("<a href='"+GetPath(vLevel)+"Section2/Section1/Project1.html'>Gynowars RPG</a>");
				document.write("</span>");
				document.write("<span class='navlink'>");
					document.write("<a href='"+GetPath(vLevel)+"Section2/Section1/Project2.html'>Gynowars: Battle Arena CCG</a>");
				document.write("</span>");
				document.write("<span class='navlink'>");
					document.write("<a href='"+GetPath(vLevel)+"Section2/Section1/Project3.html'>Gynowars: Crash Ball</a>");
				document.write("</span>");
			document.write("</h5>");
	document.write("</span>");
	document.write("<br>");
