function getNavigation(vLevel)
{
	...
	vResult +="<a class=\"navlinkA\" href=\""+GetPath(vLevel)+"Section2/Section4/Index.aspx\">Renley</a><br><br>";
		vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section2/Section4/Project1.aspx\">Warring Nations</a><br><br>";
		vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section2/Section4/Project2.aspx\">Psychodom: The One Empire</a><br><br>";
