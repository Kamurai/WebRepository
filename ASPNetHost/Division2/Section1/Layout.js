function getNavigation(vLevel)
{
	...
	vResult +="<a class=\"navlinkA\" href=\""+GetPath(vLevel)+"Section2/Section1/Index.aspx\">Gynowars</a><br><br>";
		vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section2/Section1/Project1.aspx\">Gynowars RPG</a><br><br>";
		vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section2/Section1/Project2.aspx\">Gynowars: Battle Arena CCG</a><br><br>";
		vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section2/Section1/Project3.aspx\">Gynowars: Crash Ball</a><br><br>";
