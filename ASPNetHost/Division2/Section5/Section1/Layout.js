function getNavigation(vLevel)
{
	...
	vResult +="<a class=\"navlinkA\" href=\""+GetPath(vLevel)+"Section2/Section5/Index.aspx\">Antarrea</a><br><br>";
		vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section2/Section5/Section1/Index.aspx\">Global</a><br><br>";
			vResult +="<a class=\"navlinkC\" href=\""+GetPath(vLevel)+"Section2/Section5/Section1/Project1.aspx\">Team Tactial: Crash Ball</a><br><br>";
			vResult +="<a class=\"navlinkC\" href=\""+GetPath(vLevel)+"Section2/Section5/Section1/Project2.aspx\">Wars of Antarrea</a><br><br>";
			vResult +="<a class=\"navlinkC\" href=\""+GetPath(vLevel)+"Section2/Section5/Section1/Project3.aspx\">Revolutions: Invading Nations</a><br><br>";
			vResult +="<a class=\"navlinkC\" href=\""+GetPath(vLevel)+"Section2/Section5/Section1/Project4.aspx\">Revolutions: Rebellion Against the Fist</a><br><br>";
			vResult +="<a class=\"navlinkC\" href=\""+GetPath(vLevel)+"Section2/Section5/Section1/Project5.aspx\">Revolutions: Return to Arms</a><br><br>";
			vResult +="<a class=\"navlinkC\" href=\""+GetPath(vLevel)+"Section2/Section5/Section1/Project6.aspx\">Revolutions: Post Wars</a><br><br>";
