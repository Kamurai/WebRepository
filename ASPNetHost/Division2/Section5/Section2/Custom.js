function Navigation(vLevel)
{
	...
	Response.Write("<a class=\"navlinkA\" href=\""+GetPath(vLevel)+"Section2/Section5/Index.aspx\">Antarrea</a><br><br>");
		...
		Response.Write("<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section2/Section5/Section2/Index.aspx\">Grendol</a><br><br>");
			Response.Write("<a class=\"navlinkC\" href=\""+GetPath(vLevel)+"Section2/Section5/Section2/Project1.aspx\">Land of the Orcish Empire: Age of Magic</a><br><br>");
			Response.Write("<a class=\"navlinkC\" href=\""+GetPath(vLevel)+"Section2/Section5/Section2/Project2.aspx\">Coliseum: Arena</a><br><br>");
...
function Versions(vPage, vExtension)
{
	...
	if(vPage == 0)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:81/ASP/Section2/Section5/Section2/Index.asp\">ASP VBscript</a><br>");
	...
	else if(vPage == 1)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:81/ASP/Section2/Section5/Section2/Project1.asp\">ASP VBscript</a><br>");
	...
	else if(vPage == 2)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:81/ASP/Section2/Section5/Section2/Project2.asp\">ASP VBscript</a><br>");
