function getNavigation(vLevel)
{
	...
	vResult += "<a class=\"navlinkA\" href=\""+getPath(vLevel)+"Division2/Section5/Index.aspx\">Antarrea</a><br><br>";
		...
		vResult += "<a class=\"navlinkB\" href=\""+getPath(vLevel)+"Division2/Section5/Section2/Index.aspx\">Grendol</a><br><br>";
			vResult += "<a class=\"navlinkC\" href=\""+getPath(vLevel)+"Division2/Section5/Section2/Project1.aspx\">Land of the Orcish Empire: Age of Magic</a><br><br>";
			vResult += "<a class=\"navlinkC\" href=\""+getPath(vLevel)+"Division2/Section5/Section2/Project2.aspx\">Coliseum: Arena</a><br><br>";
