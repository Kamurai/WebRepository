function getNavigation(vLevel)
{
    ...
    vResult +="<a class=\"navlinkA\" href=\""+GetPath(vLevel)+"Section1/Section6/Index.aspx\">Databases</a><br><br>";
        vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section1/Section6/Project1.aspx\">Oracle</a><br><br>";
        vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section1/Section6/Project2.aspx\">Derby</a><br><br>";
        vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section1/Section6/Project3.aspx\">MySQL</a><br><br>";
        vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section1/Section6/Project4.aspx\">SQL Server</a><br><br>";
        vResult +="<a class=\"navlinkB\" href=\""+GetPath(vLevel)+"Section1/Section6/Project5.aspx\">Postgres</a><br><br>";
}
