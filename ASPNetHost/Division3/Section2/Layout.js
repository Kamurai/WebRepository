function getNavigation(vLevel){
	...
	vResult += "<ul class=\"navigationUl\">";
		vResult += "<li><a class=\"navlinkA\" href=\"../Indx.aspx\">Video Games</a></li>";
		...
		vResult += "<ul class=\"navigationUl\">";
			vResult += "<li><a class=\"navlinkB\" href=\"./Project1.aspx\">Warring Nations</a></li>";
			vResult += "<li><a class=\"navlinkB\" href=\"./Project2.aspx\">Psychodom: The One Empire</a></li>";
		vResult += "</ul>";
	vResult += "</ul>";
