function getNavigation(vLevel){
	...
	vResult += "<ul class=\"navigationUl\">";
		...
		vResult += "<ul class=\"navigationUl\">";
			vResult += "<li><a class=\"navlinkB\" href=\"./Project1.aspx\">Revolutions: Invading Nations</a></li>";
			vResult += "<li><a class=\"navlinkB\" href=\"./Project2.aspx\">Revolutions: Rebellion Against the Fist</a></li>";
			vResult += "<li><a class=\"navlinkB\" href=\"./Project3.aspx\">Revolutions: Return to Arms</a></li>";
			vResult += "<li><a class=\"navlinkB\" href=\"./Project4.aspx\">Revolutions: Post Wars</a></li>";
			vResult += "<li><a class=\"navlinkB\" href=\"./Project5.aspx\">Avia:Elemental Angels</a></li>";
		vResult += "</ul>";
