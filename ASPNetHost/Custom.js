...
function getContent(vPage)
{
    vResult +="<p id=\"idCenterContent\">";
        if(vPage == 0)
        {
            vResult +="The House That Kamurai Built is an entertainment company with the primary focus ";
            vResult +="of increasing awesome by stimulating intelligent conversation and entertainment via discussion and ";
            vResult +="game design.<br>";
...
function getVersions(vPage)
{
	...
	if(vPage == 0)
	{
		vResult +="<a href=\"http://htkb.dyndns.org/Index.html\">HTML</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org/Index.php\">PHP</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org/Javascript/Index.html\">HTML Javascript</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org/JQuery/Index.html\">JQuery</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org:81/ASP/Index.asp\">ASP VBscript</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org:84/Index\">Node JS</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org/Index.shtml\">Perl</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org:8080/JSPApplication/Index.jsp\">JSP</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org:8080/JSFApplication/Index.xhtml\">JSF</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org:81/WebApplication/Index.cshtml\">ASP.NET Web App</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org:81/WebForm/Index.aspx\">ASP.NET Webform</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org:81/MVC/Main/Index\">ASP.NET MVC App</a><br>";
		vResult +="<a href=\"http://htkb.dyndns.org/SSI/Index.html\">Apache SSI</a><br>";
	    vResult +="<a href=\"http://htkb.dyndns.org:82/Index\">Python Web.py</a><br>";
        vResult +="<a href=\"http://htkb.dyndns.org:83/Index\">Ruby On Rails</a><br>";
    }
	else if(vPage == 1)
	{
