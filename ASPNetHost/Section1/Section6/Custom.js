...
function Versions(vPage)
{
	...
	if(vPage == 0)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:81/ASP/Section1/Section6/Index.asp\">ASP VBscript</a><br>");
	...
	else if(vPage == 1)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:81/ASP/Section1/Section6/Project1.asp\">ASP VBscript</a><br>");
	...
	else if(vPage == 2)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:81/ASP/Section1/Section6/Project2.asp\">ASP VBscript</a><br>");
	...
	else if(vPage == 3)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:81/ASP/Section1/Section6/Project3.asp\">ASP VBscript</a><br>");
