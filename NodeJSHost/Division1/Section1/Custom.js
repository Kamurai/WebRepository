...
exports.getVersions = function (vPage)
{
	...
	if(vPage == 0)
	{
		...
		vResult += "<a href=\"http://htkb.dyndns.org:81/MVC/Division1/Section1/Index\">ASP.NET MVC App</a><br>";
	    vResult += "<a href=\"http://htkb.dyndns.org:82/Division1/Section1/Index\">Python Web.py</a><br>";
