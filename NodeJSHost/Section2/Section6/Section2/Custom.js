...
exports.Versions = function (vPage)
{
	...
	if(vPage == 0)
	{
        ...
        result += "<a href=\"http://htkb.dyndns.org/JQuery/Section2/Section6/Section2/index.html\">JQuery</a><br>";
	...
	else if(vPage == 1)
	{
        ...
        result += "<a href=\"http://htkb.dyndns.org/JQuery/Section2/Section6/Section2/Project1.html\">JQuery</a><br>";
