<?php
    ...
    function Versions($Page)
    {
        ...
        $Default = '
			...
			<a href=\'http://htkb.dyndns.org:81/ASP/Division2/Section1/index.asp\'>ASP Javascript</a><br>
        ...
        else if($Page==1)
        {
            $Result = $Result.'
				...
				<a href=\'http://htkb.dyndns.org:81/ASP/Division2/Section1/Project1.asp\'>ASP Javascript</a><br>
        ...
        else if($Page==2)
        {
            $Result = $Result.'
				...
				<a href=\'http://htkb.dyndns.org:81/ASP/Division2/Section1/Project2.asp\'>ASP Javascript</a><br>
        ...
        else if($Page==3)
        {
            $Result = $Result.'
				...
				<a href=\'http://htkb.dyndns.org:81/ASP/Division2/Section1/Project3.asp\'>ASP Javascript</a><br>
