...
Function getVersions(vPage)
	...
	vDefault = vDefault + "<a href=""http://htkb.dyndns.org/Index.php"">PHP</a><br>"
	...
	vDefault = vDefault + "<a href=""http://htkb.dyndns.org:81/MVC/Main/Index"">ASP.NET MVC App</a><br>"
    ...
    ElseIf vPage = 1 Then
		...
		vResult = vResult + "<a href=""http://htkb.dyndns.org/AboutUs.php"">PHP</a><br>"
		...
		vResult = vResult + "<a href=""http://htkb.dyndns.org:81/MVC/Main/AboutUs"">ASP.NET MVC App</a><br>"
    ...
    ElseIf vPage = 2 Then
		...
		vResult = vResult + "<a href=""http://htkb.dyndns.org/Media.php"">PHP</a><br>"
		...
		vResult = vResult + "<a href=""http://htkb.dyndns.org:81/MVC/Main/Media"">ASP.NET MVC App</a><br>"
    ...
    ElseIf vPage = 3 Then
		...
		vResult = vResult + "<a href=""http://htkb.dyndns.org/Minecraft.php"">PHP</a><br>"
		...
		vResult = vResult + "<a href=""http://htkb.dyndns.org:81/MVC/Main/Minecraft"">ASP.NET MVC App</a><br>"
