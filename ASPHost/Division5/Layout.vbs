function getNavigation(vLevel)
    ...
    vResult = vResult + "<ul class=""navigationUl"">"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Index.asp"">Database Work</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project1.asp"">Oracle</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project2.asp"">Derby</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project3.asp"">MySQL</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project4.asp"">SQL Server</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project5.asp"">Postgres</a></li>"
	vResult = vResult + "</ul>"
