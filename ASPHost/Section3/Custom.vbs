...
{
	Response.Write("<a class=""navlinkA"" href="""+GetPath(vLevel)+"Section3/Project1.asp"">Online Experience Downloads</a><br><br>");
	Response.Write("<a class=""navlinkA"" href="""+GetPath(vLevel)+"Section3/Project2.asp"">Game Maker Downloads</a><br><br>");
	Response.Write("<a class=""navlinkA"" href="""+GetPath(vLevel)+"Section3/Project3.asp"">Java Downloads</a><br><br>");
	Response.Write("<a class=""navlinkA"" href="""+GetPath(vLevel)+"Section3/Project4.asp"">C# Downloads</a><br><br>");
	Response.Write("<a class=""navlinkA"" href="""+GetPath(vLevel)+"Section3/Project5.asp"">C++ Downloads</a><br><br>");
}
...
function Versions(vPage)
{
	...
	if(vPage == 0)
	{
		...
		Response.Write("<a href=""http://htkb.dyndns.org/VBScript/Section3/Index.html"">HTML VBScript</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org/JQuery/Section3/Index.html"">JQuery</a><br>");
        Response.Write("<a href=""http://htkb.dyndns.org:81/ASPNET/Section3/Index.aspx"">ASP.NET VBScript</a><br>");
		...
		Response.Write("<a href=""http://htkb.dyndns.org:8080/JSPApplication/Section3/Index.vbsp"">JSP</a><br>");
	...
	else if(vPage == 1)
	{
		...
		Response.Write("<a href=""http://htkb.dyndns.org/VBScript/Section3/Project1.html"">HTML VBScript</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org/JQuery/Section3/Project1.html"">JQuery</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org:81/ASPNET/Section3/Project1.aspx"">ASP.NET VBScript</a><br>");
		...
		Response.Write("<a href=""http://htkb.dyndns.org:8080/JSPApplication/Section3/Project1.vbsp"">JSP</a><br>");
	...
	else if(vPage == 2)
	{
		...
		Response.Write("<a href=""http://htkb.dyndns.org/VBScript/Section3/Project2.html"">HTML VBScript</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org/JQuery/Section3/Project2.html"">JQuery</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org:81/ASPNET/Section3/Project2.aspx"">ASP.NET VBScript</a><br>");
		...
		Response.Write("<a href=""http://htkb.dyndns.org:8080/JSPApplication/Section3/Project2.vbsp"">JSP</a><br>");
	...
	else if(vPage == 3)
	{
		...
		Response.Write("<a href=""http://htkb.dyndns.org/VBScript/Section3/Project3.html"">HTML VBScript</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org/JQuery/Section3/Project3.html"">JQuery</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org:81/ASPNET/Section3/Project3.aspx"">ASP.NET VBScript</a><br>");
		...
		Response.Write("<a href=""http://htkb.dyndns.org:8080/JSPApplication/Section3/Project3.vbsp"">JSP</a><br>");
