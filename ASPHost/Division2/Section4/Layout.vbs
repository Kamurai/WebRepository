function getNavigation(vLevel)
	...
	vResult = vResult + "<a class=""navlinkA"" href="""+getPath(vLevel)+"Division2/Section4/Index.asp"">Renley</a><br><br>"
		vResult = vResult + "<a class=""navlinkB"" href="""+getPath(vLevel)+"Division2/Section4/Project1.asp"">Warring Nations</a><br><br>"
		vResult = vResult + "<a class=""navlinkB"" href="""+getPath(vLevel)+"Division2/Section4/Project2.asp"">Psychodom: The One Empire</a><br><br>"
