function getNavigation(vLevel)
{
	...
	vResult += "<a class=""navlinkA"" href="""+getPath(vLevel)+"Division2/Section5/Index.asp"">Antarrea</a><br><br>";
		vResult += "<a class=""navlinkB"" href="""+getPath(vLevel)+"Division2/Section5/Section1/Index.asp"">Global</a><br><br>";
			vResult += "<a class=""navlinkC"" href="""+getPath(vLevel)+"Division2/Section5/Section1/Project1.asp"">Team Tactial: Crash Ball</a><br><br>";
			vResult += "<a class=""navlinkC"" href="""+getPath(vLevel)+"Division2/Section5/Section1/Project2.asp"">Wars of Antarrea</a><br><br>";
			vResult += "<a class=""navlinkC"" href="""+getPath(vLevel)+"Division2/Section5/Section1/Project3.asp"">Revolutions: Invading Nations</a><br><br>";
			vResult += "<a class=""navlinkC"" href="""+getPath(vLevel)+"Division2/Section5/Section1/Project4.asp"">Revolutions: Rebellion Against the Fist</a><br><br>";
			vResult += "<a class=""navlinkC"" href="""+getPath(vLevel)+"Division2/Section5/Section1/Project5.asp"">Revolutions: Return to Arms</a><br><br>";
			vResult += "<a class=""navlinkC"" href="""+getPath(vLevel)+"Division2/Section5/Section1/Project6.asp"">Revolutions: Post Wars</a><br><br>";
