function getNavigation(vLevel)
	...
	vResult = vResult + "<a class=""navlinkA"" href="""+getPath(vLevel)+"Division2/Section5/Index.asp"">Antarrea</a><br><br>"
		...
		vResult = vResult + "<a class=""navlinkB"" href="""+getPath(vLevel)+"Division2/Section5/Section2/Index.asp"">Grendol</a><br><br>"
			vResult = vResult + "<a class=""navlinkC"" href="""+getPath(vLevel)+"Division2/Section5/Section2/Project1.asp"">Land of the Orcish Empire: Age of Magic</a><br><br>"
			vResult = vResult + "<a class=""navlinkC"" href="""+getPath(vLevel)+"Division2/Section5/Section2/Project2.asp"">Coliseum: Arena</a><br><br>"
