...
function Versions(vPage)
{
	...
	if(vPage == 0)
	{
		...
		Response.Write("<a href=""http://htkb.dyndns.org/VBScript/Section21/Section5/Index.html"">HTML VBScript</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org/JQuery/Section21/Section5/Index.html"">JQuery</a><br>");
		Response.Write("<a href=""http://htkb.dyndns.org:81/ASPNET/Section2/Section5/Index.aspx"">ASP.NET VBScript</a><br>");
		...
		Response.Write("<a href=""http://htkb.dyndns.org:8080/JSPApplication/Section2/Section5/Index.vbsp"">JSP</a><br>");
