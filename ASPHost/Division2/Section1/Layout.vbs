function getNavigation(vLevel)
{
	...
	vResult += "<a class=""navlinkA"" href="""+getPath(vLevel)+"Division2/Section1/Index.asp"">Gynowars</a><br><br>";
		vResult += "<a class=""navlinkB"" href="""+getPath(vLevel)+"Division2/Section1/Project1.asp"">Gynowars RPG</a><br><br>";
		vResult += "<a class=""navlinkB"" href="""+getPath(vLevel)+"Division2/Section1/Project2.asp"">Gynowars: Battle Arena CCG</a><br><br>";
		vResult += "<a class=""navlinkB"" href="""+getPath(vLevel)+"Division2/Section1/Project3.asp"">Gynowars: Crash Ball</a><br><br>";
