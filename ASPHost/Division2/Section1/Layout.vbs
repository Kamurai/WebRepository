function getNavigation(vLevel)
	...
	vResult = vResult + "<ul class=""navigationUl"">"
		...
		vResult = vResult + "<ul class=""navigationUl"">"
			vResult = vResult + "<li><a class=""navlinkB"" href=""./Project1.asp"">Antarrea: Crash Ball</a></li>"
			vResult = vResult + "<li><a class=""navlinkB"" href=""./Project2.asp"">Gynowars: Crash Ball</a></li>"
		vResult = vResult + "</ul>"
	vResult = vResult + "</ul>"
