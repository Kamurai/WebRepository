function getNavigation(vLevel)
	...
	vResult = vResult + "<ul class=""navigationUl"">"
		vResult = vResult + "<li><a class=""navlinkA"" href=""../Index.asp"">Video Games</a></li>"
		...
		vResult = vResult + "<ul class=""navigationUl"">"
			vResult = vResult + "<li><a class=""navlinkB"" href=""./Project1.asp"">Revolutions: Invading Nations</a></li>"
			vResult = vResult + "<li><a class=""navlinkB"" href=""./Project2.asp"">Revolutions: Rebellion Against the Fist</a></li>"
			vResult = vResult + "<li><a class=""navlinkB"" href=""./Project3.asp"">Revolutions: Return to Arms</a></li>"
			vResult = vResult + "<li><a class=""navlinkB"" href=""./Project4.asp"">Revolutions: Post Wars</a></li>"
			vResult = vResult + "<li><a class=""navlinkB"" href=""./Project5.asp"">Avia:Elemental Angels</a></li>"
		vResult = vResult + "</ul>"
