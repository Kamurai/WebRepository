function getNavigation(vLevel)
	...
	vResult = vResult + "<ul class=""navigationUl"">"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Index.asp"">Downloadables</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project1.asp"">Cube World</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project2.asp"">Minecraft</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project3.asp"">Game Maker</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project4.asp"">Java</a></li>"
		vResult = vResult + "<li><a class=""navlinkA"" href=""./Project5.asp"">C#</a></li>"
	vResult = vResult + "</ul>"
