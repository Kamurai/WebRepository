...
function Versions(vPage, vExtension)
{
	...
	if(vPage == 0)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org/Javascript/Section2/Section6/Section2/index.html\">HTML Javascript</a><br>");
		Response.Write("<a href=\"http://htkb.dyndns.org/JQuery/Section2/Section6/Section2/index.html\">JQuery</a><br>");
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:84/Section2/Section6/Section2/index\">Node JS</a><br>");
	    ...
	    Response.Write("<a href=\"http://htkb.dyndns.org:82/Section2/Section6/Section2/index\">Python Web.py</a><br>");
        Response.Write("<a href=\"http://htkb.dyndns.org:83/Section2/Section6/Section2/index\">Ruby On Rails</a><br>");
    }
	else if(vPage == 1)
	{
		...
		Response.Write("<a href=\"http://htkb.dyndns.org/Javascript/Section2/Section6/Section2/Project1.html\">HTML Javascript</a><br>");
		Response.Write("<a href=\"http://htkb.dyndns.org/JQuery/Section2/Section6/Section2/Project1.html\">JQuery</a><br>");
		...
		Response.Write("<a href=\"http://htkb.dyndns.org:84/Section2/Section6/Section2/Project1\">Node JS</a><br>");
	    ...
	    Response.Write("<a href=\"http://htkb.dyndns.org:82/Section2/Section6/Section2/Project1\">Python Web.py</a><br>");
        Response.Write("<a href=\"http://htkb.dyndns.org:83/Section2/Section6/Section2/Project1\">Ruby On Rails</a><br>");
    }
