...
print "<a href='".$Path."Section1/Section6/Index.shtml'>Databases</a></br></br>";
	print "<a href='".$Path."Section1/Section6/Project1.shtml'>Oracle</a></br></br>";
	print "<a href='".$Path."Section1/Section6/Project2.shtml'>MySQL</a></br></br>";
	print "<a href='".$Path."Section1/Section6/Project3.shtml'>Postgres</a></br></br>";
	print "<a href='".$Path."Section1/Section6/Project4.shtml'>XML</a></br></br>";
