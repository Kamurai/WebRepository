...
print "<a href='".$Path."Section1/Section5/Index.shtml'>ASP.NET</a></br></br>";
	print "<a href='http://htkb.dyndns.org:81/WebApplication/Section1/Section5/Project1.cshtml'>Webpage Application</a></br></br>";
	print "<a href='http://htkb.dyndns.org:81/WebForm/Section1/Section5/Project2.aspx'>Webform Application</a></br></br>";
	print "<a href='http://htkb.dyndns.org:81/MVC/Section1_5/Project3'>MVC Application</a></br></br>";
