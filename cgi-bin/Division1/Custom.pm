...
sub getContent{
	...
	$vResult .= "<div id=\"idCenterContent\">";
		if($vPage <= 0){
			...
			$vResult .= "
				This section is dedicated to the Antarrea RPG project.<br/>
			";
		}elsif($vPage == 18){
			$vResult .= "
				This section is dedicated to the \"Super Dungeon Adventure\" RPG project.<br/>
			";
		}else{
			$vResult .= $vDefault;
		}
