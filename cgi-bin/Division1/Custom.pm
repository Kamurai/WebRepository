sub Navigation
{
	...
	print "<a class=\"navlinkA\" href='".$vPath."Section1/Index.html'>Basic HTML</a><br><br>";
	print "<a class=\"navlinkA\" href='".$vPath."Section1/Index.php'>PHP</a><br><br>";
	print "<a class=\"navlinkA\" href='".$vPath."Section1/Section2/Index.shtml'>Javascript</a><br><br>";
	print "<a class=\"navlinkA\" href='".$vPath."Section1/Index.shtml'>Perl</a><br><br>";
	print "<a class=\"navlinkA\" href='".$vPath."Section1/Section4/Index.shtml'>Java</a><br><br>";
	print "<a class=\"navlinkA\" href='".$vPath."Section1/Section5/Index.shtml'>ASP.Net</a><br><br>";
	print "<a class=\"navlinkA\" href='".$vPath."Section1/Section6/Index.shtml'>Databases</a><br><br>";
