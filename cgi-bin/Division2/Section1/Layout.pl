...
sub Navigation
{
	...
	$vResult += "<a class=\"navlinkA\" href='".getPath($vLevel)."Section2/Section1/Index.shtml'>Gynowars</a><br><br>";
		$vResult += "<a class=\"navlinkB\" href='".getPath($vLevel)."Section2/Section1/Project1.shtml'>Gynowars RPG</a><br><br>";
		$vResult += "<a class=\"navlinkB\" href='".getPath($vLevel)."Section2/Section1/Project2.shtml'>Gynowars: Battle Arena CCG</a><br><br>";
		$vResult += "<a class=\"navlinkB\" href='".getPath($vLevel)."Section2/Section1/Project3.shtml'>Gynowars: Crash Ball</a><br><br>";
