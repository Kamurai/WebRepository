...
sub getNavigation
{
	...
	$vResult .= "<a class=\"navlinkA\" href='".getPath($vLevel)."Division2/Section5/Index.shtml'>Antarrea</a><br><br>";
		$vResult .= "<a class=\"navlinkB\" href='".getPath($vLevel)."Division2/Section5/Section1/Index.shtml'>Global</a><br><br>";
			$vResult .= "<a class=\"navlinkC\" href='".getPath($vLevel)."Division2/Section5/Section1/Project1.shtml'>Team Tactial: Crash Ball</a><br><br>";
			$vResult .= "<a class=\"navlinkC\" href='".getPath($vLevel)."Division2/Section5/Section1/Project2.shtml'>Wars of Antarrea</a><br><br>";
			$vResult .= "<a class=\"navlinkC\" href='".getPath($vLevel)."Division2/Section5/Section1/Project3.shtml'>Revolutions: Invading Nations</a><br><br>";
			$vResult .= "<a class=\"navlinkC\" href='".getPath($vLevel)."Division2/Section5/Section1/Project4.shtml'>Revolutions: Rebellion Against the Fist</a><br><br>";
			$vResult .= "<a class=\"navlinkC\" href='".getPath($vLevel)."Division2/Section5/Section1/Project5.shtml'>Revolutions: Return to Arms</a><br><br>";
			$vResult .= "<a class=\"navlinkC\" href='".getPath($vLevel)."Division2/Section5/Section1/Project6.shtml'>Revolutions: Post Wars</a><br><br>";
