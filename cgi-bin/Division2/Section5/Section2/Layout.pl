...
sub Navigation
{
	...
	$vResult += "<a class=\"navlinkA\" href='".getPath($vLevel)."Section2/Section5/Index.shtml'>Antarrea</a><br><br>";
		...
		$vResult += "<a class=\"navlinkB\" href='".getPath($vLevel)."Section2/Section5/Section2/Index.shtml'>Grendol</a><br><br>";
			$vResult += "<a class=\"navlinkC\" href='".getPath($vLevel)."Section2/Section5/Section2/Project1.shtml'>Land of the Orcish Empire: Age of Magic</a><br><br>";
			$vResult += "<a class=\"navlinkC\" href='".getPath($vLevel)."Section2/Section5/Section2/Project2.shtml'>Coliseum: Arena</a><br><br>";
