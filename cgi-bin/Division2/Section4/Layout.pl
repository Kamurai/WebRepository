...
sub Navigation
{
	...
	$vResult += "<a class=\"navlinkA\" href='".getPath($vLevel)."Section2/Section4/Index.shtml'>Renley</a><br><br>";
		$vResult += "<a class=\"navlinkB\" href='".getPath($vLevel)."Section2/Section4/Project1.shtml'>Warring Nations</a><br><br>";
		$vResult += "<a class=\"navlinkB\" href='".getPath($vLevel)."Section2/Section4/Project2.shtml'>Psychodom: The One Empire</a><br><br>";
