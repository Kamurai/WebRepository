...
sub getVersions
{
	...
	$vDefault .= "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Index\">JSP Spring MVC</a><br>";
	...
	elsif($vPage == 1)
	{
		...
		$vResult .= "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/AboutUs\">JSP Spring MVC</a><br>";
	...
	elsif($vPage == 2)
	{
		...
		$vResult .= "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Media\">JSP Spring MVC</a><br>";
	...
	elsif($vPage == 3)
	{
		...
		$vResult .= "<a href=\"http://htkb.dyndns.org:8080/ProjectSpringTestSite/Minecraft\">JSP Spring MVC</a><br>";
