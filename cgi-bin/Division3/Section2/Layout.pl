...
sub getNavigation{
	...
	$vResult .= "
		<ul class=\"navigationUl\">
			<li><a class=\"navlinkA\" href=\"../Index.shtml\">Vidoe Games</a></li>
			...
			<ul class=\"navigationUl\">
				<li><a class=\"navlinkB\" href=\"./Project1.shtml\">Warring Nations</a></li>
				<li><a class=\"navlinkB\" href=\"./Project2.shtml\">Psychodom: The One Empire</a></li>
			</ul>
		</ul>
	";
